<template>
    ...
    <div>
        <nav class="navbar bg-info text-light fixed-top">
        ...
        <div class="container-fluid row">
            ...
            <div class="col-sm-3 col-xs-4">
                ...
                <div style="height: 74vh; overflow-y:scroll; overflow-x:hidden;">
        ...
        <nav class="navbar bg-info text-light fixed-bottom">
            <button class="btn btn-info">
